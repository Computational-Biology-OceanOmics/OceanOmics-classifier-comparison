...
# Now Rottnest island vs 12S

```{r}
rottnest_12S <- data |> filter(Query == 'make_12s_16s_simulated_reads_8-Rottnest_runEDNAFLOW_12S_RESULTS_dada2_asv.fa' & Subject == '12s_v010_final.fasta')
rottnest_12S
```

# Now Rottnest island vs 16S